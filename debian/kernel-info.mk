...
KERNEL_BOOTIMAGE_CMDLINE = console=tty0 androidboot.console=ttyMSM0 printk.devkmsg=on msm_rtb.filter=0x237 ehci-hcd.park=3 service_locator.enable=1 firmware_class.path=/vendor/firmware cgroup.memory=nokmem lpm_levels.sleep_disabled=1 loop.max_part=7 androidboot.boot_devices=soc/7c4000.sdhci androidboot.super_partition=system buildvariant=userdebug droidian.lvm.prefer
...
DEVICE_FULL_NAME = Google Pixel 3a XL
...
# Defconfig to use
KERNEL_DEFCONFIG = bonito_defconfig
...
#KERNEL_IMAGE_DTB = arch/arm64/boot/dts/qcom/
